export const Loading = () => {
  return (
    <svg className="animate-spin [animation-duration:2s]" version="1.1" id="Layer_1" x="0px" y="0px" width="50px" height="50px" viewBox="0 0 24 24" enableBackground="new 0 0 24 24">
<g>
	<g>
		<g>
