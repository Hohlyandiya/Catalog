...
export const FavoriteIcon = () => {
  return (
    <div className="relative inline-block">
      <svg width="50px" height="50px" viewBox="0 0 24 24" role="img" aria-labelledby="favouriteIconTitle" stroke="#000000" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" fill="none" color="#000000">
