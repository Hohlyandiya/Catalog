export const FavoriteProductIcon = () => {
  return (
    <svg width="20px" height="20px" viewBox="0 0 24 24" role="img" aria-labelledby="favouriteIconTitle" stroke="#FF0000" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" fill="#FF0000" color="#000000">
