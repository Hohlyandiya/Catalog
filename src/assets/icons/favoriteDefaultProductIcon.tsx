export const FavoriteDefaultProductIcon = () => {
  return (
    <svg width="20px" height="20px" viewBox="0 0 24 24" role="img" aria-labelledby="favouriteIconTitle" stroke="#000000" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" fill="none" color="#000000">
